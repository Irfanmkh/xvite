...
class DataMempelai extends Page
{
    ...
    Section::make('Mempelai Pria')
        ->schema([
            TextInput::make('mempelai.fullname_pria')
                ->label('Nama Lengkap Mempelai Pria (tambahkan title jika ada)')
                ->required()
                ->maxLength(255),
    ...
    Section::make('Mempelai Wanita')
        ->schema([
            TextInput::make('mempelai.fullname_wanita')
                ->label('Nama Lengkap Mempelai Wanita (tambahkan title jika ada)')
                ->required()
                ->maxLength(255),
    ...
    ->schema([
        Grid::make(2)->schema([
            // Kolom Kiri: Orang Tua Mempelai Pria
            Section::make('Orang Tua Mempelai Pria')
                ->schema([
                    TextInput::make('mempelai.namaAyah_pria')
                        ->label('Nama Ayah (tambahkan title jika ada)')
                        ->required()
                        ->maxLength(255),
                    TextInput::make('mempelai.namaIbu_pria')
                        ->label('Nama Ibu (tambahkan title jika ada)')
                        ->required()
                        ->maxLength(255),
                ])
                ->columnSpan(1),

            // Kolom Kanan: Orang Tua Mempelai Wanita
